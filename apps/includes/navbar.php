<div class="d-flex simplenavbar text-center justify-content-center">
    <img class="rounded"
        ...
        alt="" width="50px">
        <div class="simplenavbar text-center">
            <a href="./index.php" class="navelement">Ana Sayfa</a>
        <a href="./mysupport.php" class="navelement">Destek Taleplerim</a>
        <a href="./addsupport.php" class="navelement btn-orange">Yeni Destek Talebi Aç</a>
